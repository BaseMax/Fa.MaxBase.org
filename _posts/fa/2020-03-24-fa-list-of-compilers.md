...
در ادامه ی بحث [کامپایلر چیست](https://fa.maxbase.org/programming/what-is-compiler/) در این مطلب می توانید با کامپایلر و مفسر های مختلفی که برای زبان های برنامه نویسی معرفی شده اند اشنا شوید. سعی شده است که در لیست تمامی کامپایلر های مطرح وجود داشته باشند.
